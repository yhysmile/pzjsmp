 ...
 * @author  ZhouYuan
 */
public class RecordVo extends PageableRequestBean implements Serializable {
	/**  */
	private static final long serialVersionUID = -3556892037034586742L;
	//短信记录id
	private Long sendId;
	//短信手机号
	...
	public RecordVo(String sendPhone, String sendState, String channelName, Long channerlId, Timestamp sendTime,
